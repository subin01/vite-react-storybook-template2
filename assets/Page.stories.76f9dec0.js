...
`,locationsMap:{"logged-out":{startLoc:{col:46,line:15},endLoc:{col:72,line:15},startBody:{col:46,line:15},endBody:{col:72,line:15}},"logged-in":{startLoc:{col:46,line:15},endLoc:{col:72,line:15},startBody:{col:46,line:15},endBody:{col:72,line:15}}}},layout:"fullscreen"}},i=a(o=>e(r,{...o}),"Template"),S=i.bind({}),m=i.bind({});m.play=async({canvasElement:o})=>{const s=await l(o).getByRole("button",{name:/Log in/i});await d.click(s)};const L=["LoggedOut","LoggedIn"];export{m as LoggedIn,S as LoggedOut,L as __namedExportsOrder,P as default};
//# sourceMappingURL=Page.stories.76f9dec0.js.map
